...
//FUNCTION TO INCLUDE MY CSS AND JS FILES CDN

function theme_enqueue_styles(){
//MY CSS STYLES 

	wp_enqueue_style('My-styles', get_bloginfo('template_url').'/css/application.css');

//Latest compiled and minified CSS (BOOTSTRAP)
	wp_enqueue_style('bootstrap-minified-cdn', get_template_directory_uri().'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css');

//Optional theme (BOOTSTRAP)
	wp_enqueue_style('bootstrap-optional-theme-', get_template_directory_uri().'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap-theme.min.css');


wp_enqueue_script('my_script',get_stylesheet_directory_uri().'http://code.jquery.com/jquery-1.11.0.min.js',array('jquery'),'1.0', true);

//Latest compiled and minified JavaScript (BOOTSTRAP)
	wp_enqueue_script('javasctipt',get_stylesheet_directory_uri().'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js');
...
// //javascript 
// 		wp_enqueue_script('my_script2',get_bloginfo('template_url').'/javascript/jQuery1.11.3.js',array('jquery'),'1.0', true);

		
// //bootstrap	
// 		wp_register_script('ajaxs', get_bloginfo('template_url') . "https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js");



// 		wp_enqueue_style('bootstrap1',get_bloginfo('template_url')."https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css");

// 		wp_enqueue_style('bootstrap2',get_bloginfo('template_url')."https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap-theme.min.css");

// 	wp_enqueue_script('jquery', get_template_directory_uri().'/javascript/jQuery1.11.3.js');

// 		//bootstrapjs

// 		wp_enqueue_script('bootstrapjs',get_bloginfo('template_url')."https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js");


	

// 		wp_enqueue_script('jquery', get_template_directory_uri().'/javascript/script.js');
...
// 		wp_deregister_script('jquery');
// 		wp_register_script('https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js', false, '1.11.3', true);

// 		wp_enqueue_script('my_script',get_bloginfo('template_url').'http://code.jquery.com/jquery-1.11.0.min.js',array('jquery'),'1.0', true);
		
// 		wp_enqueue_script('my_script2',get_bloginfo('template_url').'/javascript/jQuery1.11.3.js',array('jquery'),'1.0', true);

// 		// wp_enqueue_script('my_script3',get_bloginfo('template_url').'/animsition/animsition.min.js',array('jquery'),'1.0', true);

// 		wp_enqueue_script('my_script4',get_bloginfo('template_url').'/javascript/script.js',array('jquery'),'1.0', true);

// 		wp_enqueue_script('my_script5',get_bloginfo('template_url').'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js',array('jquery'),'1.0', true);

// 		wp_enqueue_script('theme-extra1',get_stylesheet_directory_uri().'/js/modernizr-1.6.min.js');
// 	}
// }
...
//     <script type="text/JavaScript" src="javascript/jQuery1.11.3.js"></script>

  

// //Adimsition Jquery file plugin
//     // <script type="text/JavaScript" src="animsition/animsition.min.js"></script> 
